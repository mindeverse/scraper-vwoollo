"""Vwoollo scraper — scrape Shopify collections, embed with local SigLIP, upsert Supabase."""
...
logger = logging.Logger("scraper-vwoollo")
...
def run() -> dict[str, Any]:
    logger.info("=== Vwoollo scraper start ===")
    ...
    for k, v in summary.items():
        logger.info("%s: %s", k, v)
    logger.info("=== Vwoollo scraper complete ===")
    return summary
